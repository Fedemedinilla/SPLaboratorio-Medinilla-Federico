...
/** \brief Filtra un NUEVO LinkedList cargado con los elementos filtrados.
 *
 * \param LinkedList* this LinkedList a filtrar
 * \param int(*pFunc)(void*) puntero a la funcion que filtra
 * \return nuevo puntero a LinkedList con los elementos que pasaron el filtro
 *
 */
